            ...
            >
                <div className={styles.mainMenu}>
                    ...
                    <div
                        ...
                        className={classNames(styles.menuBarItem, styles.hoverable)}
                        onClick={() => { this.props.openTeacherModal(true); }}
                    >
                ...
                <div className={styles.accountInfoGroup}>
                    ...
                    {this.props.sessionExists && this.props.username ? (
                        ...
                        <React.Fragment>
                            <div style={{ display: 'flex', width: 82, height: 32, borderRadius: 5, justifyContent: 'center', alignItems: 'center', marginRight: 20, backgroundColor: '#6fbcf7' }}>LOG-IN</div>
                        </React.Fragment>
                    )}
                </div>
